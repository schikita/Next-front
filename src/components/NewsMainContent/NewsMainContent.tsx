  ...
  {loading ? (
    ...
    url && (
      <a
        ...
        className="flex items-center px-4 py-2 bg-gray-300 dark:bg-gray-700 text-gray-900 dark:text-gray-100 rounded-md font-semibold text-sm hover:bg-gray-400 dark:hover:bg-gray-600 transition mt-2 sm:mt-0"
      >
